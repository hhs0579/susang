...
const { getProductByRouteParam } = useCategoryProducts('intercom', intercomProducts)
const product = computed(() => getProductByRouteParam(route.params.id))
useProductDetailRoute('intercom', product)
...
<template>
  <main v-if="product" class="camera-detail-page">
    ...
    <section class="detail-wrap">
      <div class="detail-left">
        <RouterLink to="/intercom" class="back-link">&lt; Back to Category</RouterLink>
      ...
      <div class="detail-right">
        ...
        <p class="detail-price">
          ...
          <span v-if="hasDiscountPrice && !product.priceDisplayText" class="detail-price-note">카메라 대여시 할인가</span>
        </p>
  ...
  <main v-else class="camera-not-found">
    <h1>상품을 찾을 수 없습니다.</h1>
    <RouterLink to="/intercom">인터컴 목록으로 돌아가기</RouterLink>
  </main>
