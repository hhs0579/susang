...
const { getProductByRouteParam } = useCategoryProducts('monitor', monitorProducts)
const product = computed(() => getProductByRouteParam(route.params.id))
useProductDetailRoute('monitor', product)
...
<template>
  <main v-if="product" class="camera-detail-page">
    ...
    <section class="detail-wrap">
      <div class="detail-left">
        <RouterLink to="/monitor" class="back-link">&lt; Back to Category</RouterLink>
  ...
  <main v-else class="camera-not-found">
    <h1>상품을 찾을 수 없습니다.</h1>
    <RouterLink to="/monitor">모니터 목록으로 돌아가기</RouterLink>
  </main>
